    ...
    public function store(Request $request)
{
    ...
    if ($request->has('image')) {
        // Optionally, you can validate the image's base64 format
        // You might want to check if it's a valid base64 string, and process the image if needed

        $image = $request->image; // Image is expected to be a base64 string
    }
    ...
    $contribution = Contribution::create([
        ...
        'status' => 'Ongoing',
        'image' => $image, // Save the base64 image in the database
    ]);
